...
```bash
dotnet dev-certs https -v -ep openiddict.pfx -p 56d22484-256a-4daf-94a5-26ec46ae0ee4
```

> `56d22484-256a-4daf-94a5-26ec46ae0ee4` is the password of the certificate, you can change it to any password you want.
...
* `AbpSolution1.Blazor`: ASP.NET Core Blazor Web App application that supports server-side prerendering and optional client-side interactivity running on WebAssembly.
